-- ============================================================
--  MOPGIMED — Script completo de base de datos MySQL
--  Ejecutar en phpMyAdmin, MySQL Workbench o consola
-- ============================================================

DROP DATABASE IF EXISTS `mopgimed`;
CREATE DATABASE `mopgimed`
...
CREATE TABLE `movimientos_semana` (
  `id`       INT AUTO_INCREMENT PRIMARY KEY,
  `dia`      VARCHAR(10),
...
CREATE TABLE `predicciones_criticas` (
  `id`             INT AUTO_INCREMENT PRIMARY KEY,
  `nombre`         VARCHAR(200),
  `stock_actual`   INT,
